...
fetch("https://youtube-search1.p.rapidapi.com/why%20learn%20spanish", {
	"method": "GET",
	"headers": {
...
.then(data => {
  document.getElementById('gtg').src = "https://www.youtube.com/embed/" + data.items[0].id;
})
.catch(err => {
console.error(err);
});
...
window.alert("Welcome to my website! Don't click on the tiles too fast because it messes up the game.");
function newGame() {
  images = [];
  moves = 0;
  done = 0;
for (var i = 0; i < 8; i++) { 
  if (i == 0) {
    ...
    if (g == 1) {
      var img = '7b1a922d12c8eec5d5cf672e25cb15d22.png';
    var img2 = 'boo7b1a922d12c8eec5d5cf672e25cb15d22.png';
    }
    if (g == 2) {
      var img = 'boottttttttty.png';
    var img2 = 'ttttttttty.png';
    }
  } 
  if (i == 1) {
    var g = Math.floor(Math.random() * 3);
  ...
  if (i == 2) {
    ...
    if (g == 1) {
      var img = 'booke.png';
    var img2 = 'boobooke.png';
    }
    if (g == 2) {
      var img = 'roade.png';
    var img2 = 'booroade.png';
    }
  } 
  if (i == 3) {
    var g = Math.floor(Math.random() * 3);
    ...
    if (g == 1) {
      var img = 'planee.png';
    var img2 = 'booplanee.png';
    }
    if (g == 2) {
      var img = 'icee.png';
    var img2 = 'booicee.png';
    }
  } 
  if (i == 4) {
    var g = Math.floor(Math.random() * 3);
    ...
    if (g == 1) {
      var img = 'shirte.png';
    var img2 = 'booshirte.png';
    }
    if (g == 2) {
      var img = 'beee.png';
    var img2 = 'boobeee.png';
    }
  } 
  if (i == 5) {
    var g = Math.floor(Math.random() * 3);
    ...
    if (g == 1) {
      var img = 'tomatoe.png';
    var img2 = 'bootomatoe.png';
    }
    if (g == 2) {
      var img = 'bananase.png';
    var img2 = 'boobananase.png';
    }
  } 
  if (i == 6) {
    var g = Math.floor(Math.random() * 3);
    ...
    if (g == 1) {
      var img = 'fishe.png';
    var img2 = 'boofishe.png';
    }
    if (g == 2) {
      var img = 'rocke.png';
    var img2 = 'boorocke.png';
    }
  } 
  if (i == 7) {
    var g = Math.floor(Math.random() * 3);
    ...
    if (g == 1) {
      var img = 'shoese.png';
    var img2 = 'booshoese.png';
    }
    if (g == 2) {
      var img = 'boxe.png';
    var img2 = 'booboxe.png';
    }
  } 
  images.push(img);
  images.push(img2);
...
$('#myToggle').change(function(){
  if(this.checked) {
    ...
    document.getElementById("lll").style.backgroundColor = "black";
    document.getElementById("lll").style.color = "white";
    document.getElementById("lat").style.backgroundColor = "black";
  ...
  if(!this.checked) {
    ...
    document.getElementById("lll").style.backgroundColor = "lightgrey";
    document.getElementById("lll").style.color = "black";
    document.getElementById("lat").style.backgroundColor = "white";
...
lll.onclick = function(){
  ...
  fetch("https://air-quality.p.rapidapi.com/current/airquality?lat=" + lati + "&lon=" + longi, {
	"method": "GET",
	"headers": {
		"x-rapidapi-key": "1db57438admsh6f6638573905e76p18f437jsn7040ddba1a93",
...
.then(data => {
  ...
  document.getElementById('infoo1').innerHTML = "City closest to the coordinates: " + data.city_name;
  document.getElementById('infoo2').innerHTML = "Timezone: " + data.timezone;
  document.getElementById('infoo3').innerHTML = "Country code: " + data.country_code;
  document.getElementById('infoo4').innerHTML = "State code: " + data.state_code;
})
.catch(err => {
	console.error(err);
});
...
w.onclick = function(){
  ...
  fetch("https://translated-mymemory---translation-memory.p.rapidapi.com/api/get?q=" + trans +"&langpair=en%7Ces&de=a%40b.c&onlyprivate=0&mt=1", {
    "method": "GET",
    "headers": {
      "x-rapidapi-key": "1db57438admsh6f6638573905e76p18f437jsn7040ddba1a93",
